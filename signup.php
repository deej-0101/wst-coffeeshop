...
<head>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="nav-links">
                <a href="login.php" class="btn btn-outline-primary" style="color:rgb(255,255,255); border-color:rgb(101,67,33);">Log In</a>
                <a href="signup.php" class="btn btn-primary disabled"  aria-disabled="true" style="background-color:rgb(101,67,33); border-color:rgb(101,67,33);">Sign Up</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            ...
            <div class="card-body p-4 p-sm-5">
                <h5 class="card-title text-center mb-5 fw-light fs-5"style="color:rgb(101,67,33)"><strong>Sign Up</strong></h5>
                <form>
                ...
                <div class="d-grid">
                    <button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit" style="background-color:rgb(101,67,33); border-color:rgb(101,67,33);">Create Account</button>
                </div>
                <br>
                <div class="member text-center mt-1"> 
                    <span>Already have an account?</span> <a class="text-decoration-none" href="login.php">Log in here</a> 
                </div>
                </form>
            </div>
            </div>
